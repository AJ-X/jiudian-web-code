...
<div class = "edit">
	...
	<table>
		...
		<tr>
			<td>账号</td>
			<td><input type="text" name="zhanghao" value=<?php echo $change['zhanghao']; ?>></td>
		</tr>
		<tr>
			<td>密码</td>
			<td><input type="text" name="mima" value=<?php echo $change['mima']; ?>></td>
		</tr>
		<tr>
			<td>电话</td>
			<td><input type="text" name="phone" value=<?php echo $change['phone']; ?>></td>
		</tr>
