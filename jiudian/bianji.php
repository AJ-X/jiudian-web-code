...
<div class = "edit">
	<h3>编辑</h3>
	<table>
		<form method = "post" <?php echo "action=".$where."?id=".$id."&type=".$type ?>>
		<tr>
			<td>用户：</td>
			<td><input type="text" name="yonghu" value=<?php echo $change['yonghu']; ?>></td>
		</tr>
		<tr>
			<td>酒店</td>
			<td><input type="text" name="room" value=<?php echo $change['hotel']; ?>></td>
		</tr>
		<tr>
			<td>天数</td>
			<td><input type="text" name="days" value=<?php echo $change['tianshu']; ?>></td>
		</tr>
		<tr>
			<td>成人</td>
			<td><input type="text" name="man" value=<?php echo $change['chengren']; ?>></td>
		</tr>
		<tr>
			<td>小孩</td>
			<td><input type="text" name="kid" value=<?php echo $change['xiaohai']; ?>></td>
		</tr>
		<tr>
			<td>支付</td>
			<td><input type="text" name="pay" value=<?php echo $change['zhifu']; ?>></td>
		</tr>
