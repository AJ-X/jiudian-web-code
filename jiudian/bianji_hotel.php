...
<div class = "edit">
	<h3>编辑</h3>
	<table>
		<form method = "post" action = "ctr_hotel.php">
		<tr>
			<td>皇冠</td>
			<td><input type="text" name="huangguan" value=<?php echo $change['huangguan']; ?>></td>
		</tr>
		<tr>
			<td>欢乐</td>
			<td><input type="text" name="huanle" value=<?php echo $change['huanle']; ?>></td>
		</tr>
		<tr>
			<td>休闲</td>
			<td><input type="text" name="xiuxian" value=<?php echo $change['xiuxian']; ?>></td>
		</tr>
		<tr>
			<td>临海</td>
			<td><input type="text" name="linhai" value=<?php echo $change['linhai']; ?>></td>
		</tr>
		<tr>
			<td>舟山</td>
			<td><input type="text" name="zhoushan" value=<?php echo $change['zhoushan']; ?>></td>
		</tr>
		<tr>
			<td>海景</td>
			<td><input type="text" name="haijing" value=<?php echo $change['haijing']; ?>></td>
		</tr>
